...
const PhotoCard = ({ imageUrl, title, category, categories, onClick }) => {
  ...
  return (
    <div 
      className="bg-white rounded-2xl shadow-lg border overflow-hidden transition-all duration-200 hover:scale-105 hover:shadow-2xl hover:border-blue-200 max-w-xs w-full mx-auto flex flex-col border-gray-200"
      onClick={onClick}
