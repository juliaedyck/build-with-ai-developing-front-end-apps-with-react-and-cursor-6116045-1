...
const PhotoCard = ({ imageUrl, title, category, onClick, isSelected, isFavourite, onFavouriteToggle }) => {
  return (
    <div
    ...
    >
      <div className="p-2 flex justify-center bg-gray-50 relative">
        ...
        />
        <button
          className="absolute top-2 right-2 text-2xl focus:outline-none z-10"
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        ...
        <span className="inline-block bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 text-xs px-3 py-1 rounded-full self-start font-semibold shadow-sm border border-blue-100">{category}</span>
